...
const sections = [
  {
    ...
    body: "Julietas Flowers, Florería de Samborondón. Domiciliada en Ecuador. Correo para temas de privacidad: julietas.flowers@gmail.com — WhatsApp: +593 99 999 9999.",
  },
  {
    number: "02",
    title: "Qué datos recolectamos y para qué",
    body: "Nombre, apellido y cédula/RUC para emitir factura electrónica SRI y verificar identidad. Dirección de entrega para hacer llegar tus flores en la fecha y lugar correcto. Teléfono y correo para confirmar pedido, coordinar entrega y brindarte soporte. Datos de navegación (IP, cookies) para seguridad y mejorar tu experiencia en la web. Preferencias de flores, colores y detalles para procesar tu pedido personalizado. Número de WhatsApp para coordinar entregas especiales y soporte con tu consentimiento.",
  },
  {
    number: "03",
    title: "Pagos con Tarjeta — Datafast",
    body: "Para tu seguridad, NO almacenamos los datos de tu tarjeta. Todos los pagos online son procesados directamente por Datafast S.A., pasarela certificada bajo estándar PCI DSS Nivel 1. Tus datos viajan cifrados hacia Datafast sin pasar por nuestros servidores. Solo recibimos confirmación de pago aprobado y los últimos 4 dígitos. Si eliges guardar tarjeta, Datafast usa tokenización segura.",
  },
  {
    number: "04",
    title: "Pedidos por WhatsApp",
    body: "Al escribirnos al +593 99 999 9999, nos autorizas a usar tu número, nombre y el contenido del chat únicamente para: cotizar y procesar tu pedido de flores, enviarte la confirmación y coordinar entrega, y brindarte soporte post-compra. No usaremos tu número para publicidad sin tu consentimiento. Puedes pedir que eliminemos la conversación cuando quieras.",
  },
  {
    number: "05",
    title: "Con quién compartimos tus datos",
    body: "Solo compartimos lo mínimo necesario con: Datafast S.A. para procesar pagos; empresas de courier para hacer llegar tus flores; el SRI para emitir tu factura electrónica; Meta/Facebook y Google solo si aceptas cookies para mostrarte anuncios relevantes; y nuestro proveedor de hosting para que la web funcione. No vendemos ni alquilamos tus datos personales a nadie.",
  },
  {
    number: "06",
    title: "Tus Derechos ARCO",
    body: "Tienes derecho a: Acceso (saber qué datos tenemos tuyos), Rectificación (corregir datos incorrectos), Cancelación (eliminar tu cuenta y datos) y Oposición (que no usemos tus datos para marketing). Escríbenos a julietas.flowers@gmail.com con tu cédula y solicitud. Responderemos dentro de los plazos establecidos por la normativa ecuatoriana.",
  },
  {
    number: "07",
    title: "Cookies",
      ...
      <div className="pp-root">
        ...
        <div className="pp-body" style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                ...
                <div className="pp-contact-card">
                  <div>
                    ...
                    <a href="mailto:julietas.flowers@gmail.com" className="pp-btn">
          ...
          <div className="pp-consent">
            Al usar <strong>marcaestilo593.com</strong> y marcar la casilla <strong>"Acepto la Política de Privacidad"</strong> en el checkout, confirmas que leíste y estás de acuerdo con este documento. Conforme a la <strong>Ley Orgánica de Protección de Datos Personales de Ecuador</strong>.
          </div>
