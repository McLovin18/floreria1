...
export const Navbar = () => {
  ...
  const links = [
    { href: "/", label: "Home" },
    { href: "/nueva-coleccion", label: "Arreglos Especiales" },
    { href: "/productos", label: "Catálogo" },
    { href: "/ofertas", label: "Ofertas" },
    { href: "/blogs", label: "Consejos" },
  ];

  const infoSliderItems = [
    { text: "🌹 ¡Flores frescas con 24 hrs de anticipación! Arreglos únicos para tus momentos especiales →", href: "/ofertas" },
    "🚛 Entrega en Samborondón y alrededores • Encargos especiales disponibles",
  ];
