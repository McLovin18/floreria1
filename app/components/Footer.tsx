          ...
          <div className="flex flex-col gap-8 items-center">
            ...
            <div className={styles.ftLegalWrap}>
              <div className={styles.ftLegalRow}>
                ...
                <span>Creamos emociones con cada flor 💘</span>
                <span className={styles.ftLegalSeparator}>|</span>
                <span>Samborondón, Guayaquil, Ecuador</span>
                <span className={styles.ftLegalSeparator}>|</span>
                <a
                  href="mailto:julietas.flowers@gmail.com"
        ...
        <div className={styles.ftCopyRow}>
          ...
          <div className={styles.ftCopyRight}>
            <div className={styles.ftBadge}>
              ...
              Florería de Guayaquil 🌷
            </div>
            <a
              href="https://www.instagram.com/julietas_flowers/"
              target="_blank"
              rel="noreferrer"
